...
function Card({ pokemonId }) {
  ...
  // Sentencia IF para determinar el color del primer tipo de pokemon
  if (priType === "water") {
    var resPriType =
